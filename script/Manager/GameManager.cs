...
public class GameManager : MonoBehaviour
{
    ...
    public delegate void DataDelegate(BookData data);

   
   // public DataDelegate bookData;
    ...
    private void InitializeGameManager()
    {
        ...
        //  > 하위 매니저 클래스를 등록합니다.
         ...
         RegisterManagerClass<EventManager>();
         RegisterManagerClass<UIManager>();
         RegisterManagerClass<TextManager>();
         RegisterManagerClass<LogicManager>();
         RegisterManagerClass<ResourceManager>();
         RegisterManagerClass<BattleManager>();
